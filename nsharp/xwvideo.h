...
#include "xwcmn.h"
	...
	void show_partialthicknesses(void);
	void show_initialphase(void);
	void show_winterpage5(void);
...
/* 	void modellist_cb ( Widget w, XtPointer client_data, XtPointer call_data ); */
	...
	void prob_sigt_mlcape(void);
	void prob_sigt_mllcl(void);
	void prob_sigt_eshear(void);
	void prob_sigt_stp(void);
	void prob_sigt_stpc(void);
	void show_sars(void);
