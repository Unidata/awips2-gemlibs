...
setenv NAWIPS $GEMBASE/so_build/workspace/nawips
source $NAWIPS/environ/gemenv.csh
source $NAWIPS/site/sib_gemdat.csh
...
set myLinkflags = "-L/usr/lib/gcc/x86_64-redhat-linux/3.4.6/ -L$AWIPS2/tools/lib -shared -Wl,-soname,libbignsharp.so -o libbignsharp.so"

#set myLinkflags = "-L/usr/lib/gcc/i386-redhat-linux/3.4.6/ -L$AWIPS2/tools/lib -shared -Wl,-soname,libbignsharp.so -o libbignsharp.so"
