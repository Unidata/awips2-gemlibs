...
C*	    existing file.
C
	    WRITE (6,*) 'GDGCFL case 3'
	    CALL FL_INQR ( cpyf(1), exist, filnam, ier )
	    IF ( .not. exist ) THEN
	        WRITE (6,*) 'GDGCFL case 3 - cpyf not exist'
C
