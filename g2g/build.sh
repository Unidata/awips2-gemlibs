...
echo "OS_LIB = $OS_LIB"
echo "GEMPAK = $GEMPAK"
cd /Users/mj/awips2-gemlibs/g2g
echo "working in "`pwd`

#myCflags="$CFLAGS -I$GEMPAK/source/diaglib/dg -I$GEMPAK/source/gemlib/er -DDEBUG -c"
...
#myFflags="-fPIC -g -c -Wall -fno-second-underscore"
