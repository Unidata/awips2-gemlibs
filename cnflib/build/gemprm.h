...
#define	RMISSD	( -999999.0F )	/* Missing data value		 */
#define	RDIFFD	( 0.1F )	/* Missing value fuzziness	 */
#define	IMISSD	( -999999 )	/* Missing integer value	 */
...
#define	IA2DBGINI	(  8 )	/* A2DB sat GINI image */
#define	IA2DBNIDS	(  9 )	/* A2DB radar NIDS image */
#define	IA2DBMOSA	( 10 )	/* A2DB radar MOSAIC image */
#define	IA2DBMCID	( 11 )	/* A2DB sat MCIDAS image */
